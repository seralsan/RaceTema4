...
```{r}
cran3_1 <- cran %>% select(ip_id, package, size)
cran3_1
```
...
cran3_2 <- cran3 %>% mutate(size_mb = size / 2^20)
cran3_2
```
...
```{r}
cran3_3 <- cran3 %>% mutate(size_gb = size_mb / 2^10)
cran3_3
```
...
```{r}
cran3_4 <- cran3 %>% mutate(correct_size = size + 1000)
cran3_4
```
